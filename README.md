...
Before you begin, fork and clone this repo, run [x]`bundle install` and `rake db:migrate` to get started.
...
[x]2. On the heroines index page, a heroine's super name should link to that heroine's show page.

3. [x]The heroine show page should include the heroine's name (eg. Kamala Khan),
[x]her super name (eg. Ms. Marvel),
[x]and her power.
[x]The power should link to the power show page.  
